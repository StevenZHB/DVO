...
class STEP_BEAM_TREE(STEP_TREE):
    """
    ...
    def create_promptselect_next_step(self, outputs: Optional[List[RequestOutput]] = None) -> None:
    ...
    def generate_next_step(self, outputs: List[RequestOutput]) -> None:
        ...
        for current_node, output in zip(self.current_nodes, outputs):
            ...
            for idx, cur_output_text in enumerate(current_output_texts):
                ...
                self._updatezhegey_current_node(step_result, parser_result, idx)
